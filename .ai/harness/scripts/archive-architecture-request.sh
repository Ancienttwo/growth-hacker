...
usage() {
  cat <<'USAGE_EOF'
Usage:
  .ai/harness/scripts/archive-architecture-request.sh --request <docs/architecture/requests/file.md> --status <resolved|superseded|rejected|no-change> [--artifact <path>] [--note <text>]
