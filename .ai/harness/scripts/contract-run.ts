...
function usage(): string {
  return [
    "Usage:",
    "  bun .ai/harness/scripts/contract-run.ts dry-run --contract <contract-file> [--repo <path>] [--out <dir>] [--json]",
    "  bun .ai/harness/scripts/contract-run.ts run --contract <contract-file> --worker-command <cmd> --verifier-command <cmd> [--repo <path>] [--out <dir>] [--max-tool-calls <n>] [--json]",
  ].join("\n");
}
