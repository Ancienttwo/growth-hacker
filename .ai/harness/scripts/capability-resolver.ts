...
function usage(): never {
  console.error(
    [
      "Usage:",
      "  .ai/harness/scripts/capability-resolver.ts list [--repo <repo>] [--format json|text|prefixes]",
      "  .ai/harness/scripts/capability-resolver.ts match --path <repo-relative-path> [--repo <repo>] [--format json|text]",
      "  .ai/harness/scripts/capability-resolver.ts match --paths-from <file|-> [--repo <repo>] [--format json|text]",
      "  .ai/harness/scripts/capability-resolver.ts validate [--repo <repo>] [--format json|text]",
    ].join("\n")
  );
  process.exit(2);
}
